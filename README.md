...
This repo is the fork of [sunshineatnoon/PytorchWCT](https://github.com/sunshineatnoon/PytorchWCT). However, I have fixed it for latest pytorch version. Original models were in lua, but i have converted them into torch compatible .ph files. 
...
- Download fixed Pretrained encoder and decoder [models](https://drive.google.com/file/d/1xjzbe1ytCW5SJOwt_ddUgyTuqiRGL94E/view?usp=sharing) for image reconstruction only (download and uncompress them under models/)
- CUDA + CuDNN
